...
public class MailKitEmailService : IEmailService
{
    ...
    public MailKitEmailService(IOptions<MagicLinkSettings> options)
    {
    ...
    public async Task SendEmailAsync(EmailMessage message)
    {
        ...
        {
            await client.ConnectAsync(_options.MailServer, _options.MailKitPort, _options.MailKitUseSsl);
            if (!string.IsNullOrEmpty(_options.MailKitUsername) && !string.IsNullOrEmpty(_options.MailKitPassword))
            {
